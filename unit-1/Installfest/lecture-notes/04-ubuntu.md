...
![The terminal after installing `zsh`.](../assets/zsh-first-launch-u.png)

Enter `2` to accept the default configuration.

Your terminal prompt should look a little different now!

![zsh in action!](../assets/zsh-in-action-u.png)
...
![Creating and opening `~/.gitignore_global` in VS Code running the `code` command.](../assets/vsc-first-launch-u.png)
...
![The new .gitignore_global file open in VS Code.](../assets/vsc-gig-launch-u.png)
...
![Auto Save checked in the File menu, indicating that Auto Save is enabled.](../assets/vsc-auto-save-enabled-u.png)
...
![A successful installation of Oh My Zsh](../assets/oh-my-zsh-success-u.png)
...
![The completed installation of nvm.](../assets/nvm-install-complete-u.png)
...
![A successful install of node v20.11.0](../assets/node-install-complete-u.png)
...
![nodemon successfully installed!](../assets/nodemon-install-complete-u.png)
