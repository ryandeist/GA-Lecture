...
We also recommend downloading the Slack app for your mobile device to stay in touch on the go.
...
![A codebock shown in GitHub pages. The Copy button is being pointed at by a red arrow.](../assets/code-copy-win.png)
...
![A successful installation of Oh My Zsh](../assets/oh-my-zsh-success-win.png)
...
![The new .gitignore_global file open in VS Code.](../assets/vsc-gig-launch-win.png)
...
![Auto Save checked in the File menu, indicating that Auto Save is enabled.](../assets/vsc-auto-save-enabled-win.png)
...
![Error message reads: (Head detached at FETCH_HEAD). That can't be good!](../assets/nvm-head-detached-win.bmp)
...
![The completed installation of nvm.](../assets/nvm-install-complete-win.png)
...
![A successful install of node v20.10.0](../assets/node-install-complete-win.png)
...
![nodemon successfully installed!](../assets/nodemon-install-complete-win.png)
